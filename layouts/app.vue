        ...
        <div>
          ...
          <app-layout>
              <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
                  ...
                  <div class="face dropdown-menu dropdown-menu-right animate__animated animate__delay-1s animate__fadeInUp" aria-labelledby="dropdownMenuButton1">
                      <form class="px-4 py-3 dropdown-item">
                  ...
                  <div>
                      ...
                      <a class="btn btn-primary dropdown-toggle dropleft" data-toggle="dropdown" href="#" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                          <!-- <span class="fa fa-caret-down" title="Toggle dropdown menu"></span> -->
                      </a>
                      <div class="dropdown">
                          <ul class="dropdown-menu animated fadeInUp animate__animated animate__fadeInUp" aria-labelledby="dropdownMenuButton1" style="position:relative; left:120px;">
                          
                          <li><a class="dropdown-item" href="#"><i class="fa fa-pencil fa-fw"></i> Edit</a></li>
                      ...
                      <a class="list-group-item d-flex" href="#"><bell /><span>&nbsp; Bell Notification</span></a>
                      </div>
                      ...
                      <rectangularLoader/>
                      <doubleBounce/> -->
                      <feather-icon class="feather feather-bell"/>
                      <i data-feather="bell"></i>
                      <!-- <bell class="animate__animated animate__infinite animate__bounce"/> -->
                      <div class="animate__animated animate__infinite animate__bounce">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, iusto!
                      </div>
                      <span data-feather="feather feather-bell"></span>
                      <airplay/>
                  </div>
...
<script>
import airplay from "@/components/feather-icons/airplay";
import bell from "@/components/feather-icons/bell";
import chaseloader from "@/components/ui/chase-loader.vue";
import doubleBounce from "@/components/ui/double-bounce.vue";
import rectangularLoader from "@/components/ui/rectangular-loader.vue";

export default {
    components: {
        "app-layout": () => import("@/components/layouts/app.vue"),
        airplay, chaseloader, doubleBounce, rectangularLoader, bell
    }
}
</script>
